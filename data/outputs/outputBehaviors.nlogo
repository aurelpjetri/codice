...
to populate-initial-state
  ...
  ;set initial-state lput [30 10 0 100] initial-state
  ;set initial-state lput [40 10 0 100] initial-state
  ;set initial-state lput [10 20 0 100] initial-state
  ;set initial-state lput [20 20 0 100] initial-state
  ;set initial-state lput [30 20 0 100] initial-state
  ;set initial-state lput [40 20 0 100] initial-state
  ;set initial-state lput [10 30 0 100] initial-state
  ;set initial-state lput [20 30 0 100] initial-state
  ;set initial-state lput [30 30 0 100] initial-state
  ;set initial-state lput [40 30 0 100] initial-state
  ;set initial-state lput [10 40 0 100] initial-state
  ;set initial-state lput [20 40 0 100] initial-state
  ;set initial-state lput [30 40 0 100] initial-state
  ;set initial-state lput [40 40 0 100] initial-state
  set initial-state lput [10 10 0 100] initial-state
  set initial-state lput [20 10 0 100] initial-state
  set initial-state lput [30 10 0 100] initial-state
  set initial-state lput [40 10 0 100] initial-state
